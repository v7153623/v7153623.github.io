...
- 2023.02.20 ~ 2023.04.07 머무르다
  ...
  저는 비 개발적 측면으로는 조장으로서 jira를 이용한 프로젝트의 전체적인 일정, 진행 관리와 기획, 발표를 맡았고 
  조장으로는 백엔드 파트 전체를 맡아 jpa를 이용해 db를 구성시키고, 서버를 구성해 DB에서 필요한 정보를 가져와 FE에 넘기거나, DB에 정보를 저장할 수 있게 했습니다.
